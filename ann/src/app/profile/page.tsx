  ...
  async function deleteProfile(){
    ...
    return (
        <div className="flex justify-center items-center min-h-[100vh] w-full relative">
            <Navbar />
                <div className="bg-neutral-900 border-2 relative flex h-[500px] tablet:h-[600px] justify-center items-center desktop:max-h-[600px] max-w-[900px] opacity-90 shadow-neutral-900 shadow-2xl w-[95%] laptop:w-1/2">
