...
export default function Register() {
  ...
  return (
    <div className="h-[100vh] w-full flex justify-center items-center">
      <main className="bg-neutral-900 border-2 flex h-3/4 justify-center items-center desktop:max-h-[600px] max-w-[900px] opacity-90 relative shadow-neutral-900 shadow-2xl w-[95%] laptop:w-1/2">
